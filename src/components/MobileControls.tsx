interface Props { enabled: boolean; canStartNight: boolean; onStartNight: () => void }

type IconKind = 'backpack' | 'interact' | 'repair' | 'attack' | 'revive' | 'night';
...
export function MobileControls({ enabled, canStartNight, onStartNight }: Props) {
  const attack = () => {
